...
{/* <div className="">
    ...
    <FileUpload />
     ...
     <Sheet>
  <SheetTrigger>
  <div className="p-4 fixed  md:hidden">
  ...
  <SheetContent side={"left"} className="p-0 border-none m-0">
  

     
<div className=" h-screen  p-4 text-gray-200 bg-gray-900 flex flex-col justify-between  md:w-96  ">
